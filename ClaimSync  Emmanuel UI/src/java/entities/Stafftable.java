...
public class Stafftable  implements java.io.Serializable {
    ...
    public Stafftable(String staffid, String firstname, String lastname, Date dob, String placeofbirth, Date yearofemployment, int role, String contact, String nextofkin, int unit, boolean active) {
    ...
    public Stafftable(String staffid, String firstname, String lastname, String othername, String ssn, Date dob, String placeofbirth, Date yearofemployment, int role, String extraduty, String address, String contact, String nextofkin, String nextofkincontact, int unit, String imglocation, boolean active) {
       this.staffid = staffid;
       this.firstname = firstname;
       this.lastname = lastname;
